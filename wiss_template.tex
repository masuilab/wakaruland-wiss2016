...
大勢の人が一人ひとり何を考えてるか分かるようになるためには、思っていることをアウトプットしてもらう必要がある。
しかし、発表の途中で発言することは多くの場合発表者の話の腰を折ることになるし、
発表後の質問の時間では下手なことを言えない雰囲気が私の経験上ある。
思っていることを発言できる環境を作ることが、多くの人に今何を考えているのかをアウトプットしてもらうことに繋がるのである。
わかるらんどは「思っていることを発言しやすくする」「リアルタイムに流れる多くの情報をひと目で把握する」ことが
ダッシュボードとスタンプによって上手く両立できていると考える。
